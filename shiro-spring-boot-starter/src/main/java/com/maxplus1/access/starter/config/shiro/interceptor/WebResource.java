...
public class WebResource {
     ...
     */
    protected final static ThreadLocal<HttpServletRequest> REQUEST_THREAD = new ThreadLocal<>();

    protected final static ThreadLocal<HttpServletResponse> RESPONSE_THREAD = new ThreadLocal<>();
